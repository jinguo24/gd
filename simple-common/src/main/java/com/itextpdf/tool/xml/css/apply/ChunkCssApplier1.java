...
import com.itextpdf.tool.xml.html.HTMLUtils1;
...
public class ChunkCssApplier1 {
    ...
    public ChunkCssApplier1() {
        this(null);
    }

    public ChunkCssApplier1(FontProvider fontProvider) {
    ...
    public Chunk apply(final Chunk c, final Tag t) {
		...
		if (null != HTMLUtils1.bfCN && HTMLUtils1.isChinese(c.getContent())) {
			f = new Font(HTMLUtils1.bfCN, f.getSize(), f.getStyle(),
					f.getColor());
		}
